...
//		registerFlowerPots();
//
//		simpleBlock(ModBlocks.AMARANITA_HYMENOPHORE);
//		makeBlockItemFromExistingModel(ModBlocks.AMARANITA_HYMENOPHORE);
//		simpleBlock(ModBlocks.AMARANITA_CAP);
//		makeBlockItemFromExistingModel(ModBlocks.AMARANITA_CAP);
//		axisBlock(ModBlocks.DRAGON_BONE_BLOCK, modLoc("block/dragon_bone_block_side"), modLoc("block/dragon_bone_block_top"));
//		makeBlockItemFromExistingModel(ModBlocks.DRAGON_BONE_BLOCK);
//		stairsBlock(ModBlocks.DRAGON_BONE_STAIRS, modLoc("block/dragon_bone_block"));
//		makeBlockItemFromExistingModel(ModBlocks.DRAGON_BONE_STAIRS);
//		slabBlock(ModBlocks.DRAGON_BONE_SLAB, modLoc("block/dragon_bone_block"), modLoc("block/dragon_bone_block"));
//		makeBlockItemFromExistingModel(ModBlocks.DRAGON_BONE_SLAB);
//
//		axisBlock((RotatedPillarBlock) ModBlocks.NEON_CACTUS_BLOCK, modLoc("block/neon_cactus_block_side"), modLoc("block/neon_cactus_block_top"));
//		makeBlockItemFromExistingModel(ModBlocks.NEON_CACTUS_BLOCK);
//		stairsBlock((StairsBlock) ModBlocks.NEON_CACTUS_BLOCK_STAIRS, modLoc("block/neon_cactus_block_side"), modLoc("block/neon_cactus_block_top"), modLoc("block/neon_cactus_block_top"));
//		makeBlockItemFromExistingModel(ModBlocks.NEON_CACTUS_BLOCK_STAIRS);
//		slabBlock((SlabBlock) ModBlocks.NEON_CACTUS_BLOCK_SLAB, modLoc("block/neon_cactus_block"), modLoc("block/neon_cactus_block_side"), modLoc("block/neon_cactus_block_top"), modLoc("block/neon_cactus_block_top"));
//		makeBlockItemFromExistingModel(ModBlocks.NEON_CACTUS_BLOCK_SLAB);
//
//		simpleBlock(ModBlocks.FILALUX_LANTERN);
//		makeBlockItemFromExistingModel(ModBlocks.FILALUX_LANTERN);
//	}
//
//	private void registerLanterns()
//	{
//		lanternBlock(ModBlocks.ANDESITE_LANTERN, "andesite");
//		makeBlockItemFromExistingModel(ModBlocks.ANDESITE_LANTERN, "andesite_lantern_ceil");
//		lanternBlock(ModBlocks.DIORITE_LANTERN, "diorite");
//		makeBlockItemFromExistingModel(ModBlocks.DIORITE_LANTERN, "diorite_lantern_ceil");
//		lanternBlock(ModBlocks.GRANITE_LANTERN, "granite");
//		makeBlockItemFromExistingModel(ModBlocks.GRANITE_LANTERN, "granite_lantern_ceil");
//		lanternBlock(ModBlocks.QUARTZ_LANTERN, "quartz");
//		makeBlockItemFromExistingModel(ModBlocks.QUARTZ_LANTERN, "quartz_lantern_ceil");
//		lanternBlock(ModBlocks.PURPUR_LANTERN, "purpur");
//		makeBlockItemFromExistingModel(ModBlocks.PURPUR_LANTERN, "purpur_lantern_ceil");
//		lanternBlock(ModBlocks.END_STONE_LANTERN, "end_stone");
//		makeBlockItemFromExistingModel(ModBlocks.END_STONE_LANTERN, "end_stone_lantern_ceil");
//		lanternBlock(ModBlocks.BLACKSTONE_LANTERN, "blackstone");
//		makeBlockItemFromExistingModel(ModBlocks.BLACKSTONE_LANTERN, "blackstone_lantern_ceil");
//	}
//
//	private void registerPedestals()
//	{
//		pedestalBlock(ModBlocks.ANDESITE_PEDESTAL, "andesite", mcLoc("block/polished_andesite"), mcLoc("block/andesite_pillar"));
//		makeBlockItemFromExistingModel(ModBlocks.ANDESITE_PEDESTAL, "andesite_pedestal_default");
//		pedestalBlock(ModBlocks.DIORITE_PEDESTAL, "diorite", mcLoc("block/polished_diorite"), mcLoc("block/diorite_pillar"));
//		makeBlockItemFromExistingModel(ModBlocks.DIORITE_PEDESTAL, "diorite_pedestal_default");
//		pedestalBlock(ModBlocks.GRANITE_PEDESTAL, "granite", mcLoc("block/polished_granite"), mcLoc("block/granite_pillar"));
//		makeBlockItemFromExistingModel(ModBlocks.GRANITE_PEDESTAL, "granite_pedestal_default");
//		pedestalBlock(ModBlocks.PURPUR_PEDESTAL, "purpur", mcLoc("block/purpur_block"), mcLoc("block/purpur_pillar"));
//		makeBlockItemFromExistingModel(ModBlocks.PURPUR_PEDESTAL, "purpur_pedestal_default");
//		pedestalBlock(ModBlocks.QUARTZ_PEDESTAL, "quartz", mcLoc("block/quartz_block_side"), mcLoc("block/quartz_pillar"));
//		makeBlockItemFromExistingModel(ModBlocks.QUARTZ_PEDESTAL, "quartz_pedestal_default");
//	}
//
...
//
//		simpleBlock(material.planks);
//		makeBlockItemFromExistingModel(material.planks);
//
//		stairsBlock((StairsBlock) material.stairs, planksTexture);
//		makeBlockItemFromExistingModel(material.stairs);
//
//		slabBlock((SlabBlock) material.slab, material.planks.getRegistryName(), planksTexture);
//		makeBlockItemFromExistingModel(material.slab);
//
//		// BlockItem handled in item model provider
//		fenceBlock((FenceBlock) material.fence, planksTexture);
//
//		fenceGateBlock((FenceGateBlock) material.gate, planksTexture);
//		makeBlockItemFromExistingModel(material.gate);
//
//		// BlockItem handled in item model provider
//		doorBlock((DoorBlock) material.door, modLoc("block/" + material.name + "_door_bottom"), modLoc("block/" + material.name + "_door_top"));
//
//        trapdoorBlock((TrapDoorBlock) material.trapdoor, modLoc("block/" + material.name + "_trapdoor"), true);
//	    makeBlockItemFromExistingModel(material.trapdoor, "block/" + material.name + "_trapdoor_bottom");
//
//	    // BlockItem handled in item model provider
//	    buttonBlock((WoodButtonBlock)material.button, material.name, planksTexture);
//
//		pressurePlateBlock((PressurePlateBlock)material.pressurePlate, material.name, planksTexture);
//		makeBlockItemFromExistingModel(material.pressurePlate);
//
//	    composterBlock((ComposterBlock)material.composter, material.name);
//		makeBlockItemFromExistingModel(material.composter);
//	    craftingTableBlock((CraftingTableBlock)material.craftingTable, material.name);
//		makeBlockItemFromExistingModel(material.craftingTable);
//	    // BlockItem handled in item model provider
//	    ladderBlock((LadderBlock)material.ladder, material.name);
//	    // BlockItem handled in item model provider
//	    chestBlock(material.chest, material.name);
//	    // BlockItem handled in item model provider
//	    signBlock(material.sign, material.name);
//	    barrelBlock(material.barrel, material.name);
//		makeBlockItemFromExistingModel(material.barrel);
//	    shelfBlock(material.shelf, material.name);
//		makeBlockItemFromExistingModel(material.shelf);
//	}
//
...
//
//		simpleBlock(material.stone);
//		makeBlockItemFromExistingModel(material.stone);
//
//		simpleBlock(material.polished);
//		makeBlockItemFromExistingModel(material.polished);
//
//		simpleBlock(material.tiles);
//		makeBlockItemFromExistingModel(material.tiles);
//
//		axisBlock((PillarBlockTemplate)material.pillar, modLoc("block/" + material.name + "_pillar_side"), modLoc("block/" + material.name + "_pillar_top"));
//		makeBlockItemFromExistingModel(material.pillar);
//
//		stairsBlock((StairsBlock) material.stairs, modLoc("block/" + material.name));
//		makeBlockItemFromExistingModel(material.stairs);
//
//		slabBlock((SlabBlock) material.slab, material.stone.getRegistryName(), modLoc("block/" + material.name));
//		makeBlockItemFromExistingModel(material.slab);
//
//		// BlockItem handled in item model provider
//		wallBlock((WallBlock) material.wall, stoneTexture);
//
//		simpleBlock(material.bricks);
//		makeBlockItemFromExistingModel(material.bricks);
//
//		stairsBlock((StairsBlock) material.brick_stairs, modLoc("block/" + material.name + "_bricks"));
//		makeBlockItemFromExistingModel(material.brick_stairs);
//
//		slabBlock((SlabBlock) material.brick_slab, material.bricks.getRegistryName(), modLoc("block/" + material.name + "_bricks"));
//		makeBlockItemFromExistingModel(material.brick_slab);
//
//		// BlockItem handled in item model provider
//		wallBlock((WallBlock) material.brick_wall, modLoc("block/" + material.name + "_bricks"));
//
//		// BlockItem handled in item model provider
//		buttonBlock((StoneButtonBlock)material.button, material.name, modLoc("block/" + material.name));
//
//		pressurePlateBlock((PressurePlateBlock)material.pressure_plate, material.name, stoneTexture);
//		makeBlockItemFromExistingModel(material.pressure_plate);
//
//		lanternBlock(material.lantern, material.name);
//		makeBlockItemFromExistingModel(material.lantern, material.name + "_lantern_ceil");
//
//		pedestalBlock(material.pedestal, material.name, modLoc("block/" + material.name + "_polished"), modLoc("block/" + material.name + "_pillar_side"));
//		makeBlockItemFromExistingModel(material.pedestal, material.name + "_pedestal_default");
//
//		furnaceBlock(material.furnace, material.name);
//		makeBlockItemFromExistingModel(material.furnace, material.name + "_furnace");
//	}
//
...
//		if (material.hasOre)
//		{
//			simpleBlock(material.ore);
//			makeBlockItemFromExistingModel(material.ore);
//		}
//
//		simpleBlock(material.block);
//		makeBlockItemFromExistingModel(material.block);
//
//		simpleBlock(material.tile);
//		makeBlockItemFromExistingModel(material.tile);
//
//		stairsBlock((StairsBlock) material.stairs, modLoc("block/" + material.name + "_tile"));
//		makeBlockItemFromExistingModel(material.stairs);
//
//		slabBlock((SlabBlock) material.slab, material.tile.getRegistryName(), modLoc("block/" + material.name + "_tile"));
//		makeBlockItemFromExistingModel(material.slab);
//
//		// BlockItem handled in item model provider
//		doorBlock((DoorBlock) material.door, modLoc("block/" + material.name + "_door_bottom"), modLoc("block/" + material.name + "_door_top"));
...
//	    makeBlockItemFromExistingModel(material.trapdoor, "block/" + material.name + "_trapdoor_bottom");
//
//		pressurePlateBlock((PressurePlateBlock)material.pressure_plate, material.name, modLoc("block/" + material.name + "_block"));
//		makeBlockItemFromExistingModel(material.pressure_plate);
//
//		// BlockItem handled in item model provider
//		chainBlock(material.chain);
//
//		// BlockItem handled in item model provider
//		barsBlock(material.bars);
//
//		// BlockItem handled in item model provider
//		chandelierBlock(material.chandelier);
//
//		bulbLanterns(material.name, material.bulb_lantern, material.bulb_lantern_colored);
//
//		anvilBlock(material.anvil, material.name);
//		makeBlockItemFromExistingModel(material.anvil, "block/" + material.name + "_anvil_0");
//	}
//
