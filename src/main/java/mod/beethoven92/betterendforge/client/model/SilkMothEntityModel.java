...
public class SilkMothEntityModel extends ModelBase {
	...
	public SilkMothEntityModel() {
		...
		tendril_r_r1.setTextureOffset(23, 0).addBox(-1.5F, -5.0F, 0.0F, 3, 5, 0, true);
		...
		tendril_r_r2.setTextureOffset(23, 0).addBox(-1.5F, -5.0F, 0.0F, 3, 5, 0, 0.0F);

		bb_main = new ModelRenderer(this);
		bb_main.setRotationPoint(0.0F, 24.0F, 0.0F);
		bb_main.setTextureOffset(19, 19).addBox(-2.5F, -8.5F, -3.0F, 5, 5, 3, 0.0F);
		...
		wingR_r1.setTextureOffset(0, 5).addBox(-7.0F, 0.0F, -3.0F, 9, 0, 5, true);
		...
		wingL_r1.setTextureOffset(0, 5).addBox(-2.0F, 0.0F, -3.0F, 9, 0, 5, 0.0F);
		...
		abdomen_r1.setTextureOffset(0, 10).addBox(-3.0F, -4.0F, -1.0F, 4, 4, 7, 0.0F);
	}

	@Override
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale) {
		bb_main.render(scale);
		head_pivot.render(scale);
		legsL.render(scale);
		legsR.render(scale);
	}
	...
	public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entity) {
		wingR_r1.rotateAngleZ = MathHelper.sin(ageInTicks * 2F) * 0.4F + 0.3927F;
		wingL_r1.rotateAngleZ = -wingR_r1.rotateAngleZ;
		head_pivot.rotateAngleX = MathHelper.sin(ageInTicks * 0.03F) * 0.1F;
		tendril_r_r1.rotateAngleZ = MathHelper.sin(ageInTicks * 0.07F) * 0.2F + 0.3927F;
		tendril_r_r2.rotateAngleZ = -tendril_r_r1.rotateAngleZ;
		abdomen_r1.rotateAngleX = MathHelper.sin(ageInTicks * 0.05F) * 0.1F - 0.3927F;
		legsR.rotateAngleZ = MathHelper.sin(ageInTicks * 0.07F) * 0.1F - 0.6545F;
