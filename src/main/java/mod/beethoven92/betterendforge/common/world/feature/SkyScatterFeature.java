...
public abstract class SkyScatterFeature extends ScatterFeature {
	...
	protected BlockPos getCenterGround(World world, BlockPos pos) {
		return new BlockPos(pos.getX(), ModMathHelper.randRange(32, 192, world.rand), pos.getZ());
	}
	
	protected boolean getGroundPlant(World world, BlockPos.MutableBlockPos pos) {
		pos.setY(pos.getY() + ModMathHelper.randRange(-getYOffset(), getYOffset(), world.rand));
		return true;
	}
}
