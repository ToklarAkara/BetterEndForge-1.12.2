...
import mod.beethoven92.betterendforge.mixin.minecraft.BlockFurnaceAccessor;
...
public class EndFurnaceBlock extends BlockFurnace {
	...
	public static void setState(boolean p_176446_0_, World p_176446_1_, BlockPos p_176446_2_) {
		...
		BlockFurnaceAccessor.setKeepInventory(true);
		if (p_176446_0_) {
		...
		BlockFurnaceAccessor.setKeepInventory(false);
		if (lvt_4_1_ != null) {
			lvt_4_1_.validate();
