package mod.beethoven92.betterendforge.common.util.sdf.vector;
...
public final class Matrix3f {
   ...
   private static Quaternion stepJacobi(Matrix3f p_226120_0_) {
      ...
      if (p_226120_0_.m02 * p_226120_0_.m02 + p_226120_0_.m20 * p_226120_0_.m20 > 1.0E-6F) {
         ...
         float f5 = -pair1.getKey();
         Float f7 = pair1.getValue();
      ...
      if (p_226120_0_.m12 * p_226120_0_.m12 + p_226120_0_.m21 * p_226120_0_.m21 > 1.0E-6F) {
         ...
         Float f6 = pair2.getKey();
         Float f8 = pair2.getValue();
   ...
   public Triple<Quaternion, Vector3f, Quaternion> svdDecompose() {
      ...
      Float f1 = pair.getKey();
      Float f2 = pair.getValue();
      ...
      float f6 = -pair.getKey();
      Float f7 = pair.getValue();
      ...
      Float f11 = pair.getKey();
      Float f12 = pair.getValue();
