...
public class Vector3d implements IPosition {
   ...
   public static Vector3d EnumFacingFromRotation(Vector2f p_189984_0_) {
      return EnumFacingFromRotation(p_189984_0_.x, p_189984_0_.y);
   }

   public static Vector3d EnumFacingFromRotation(float p_189986_0_, float p_189986_1_) {
